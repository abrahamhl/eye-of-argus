...
export const XYZ_ENTRIES = Object.freeze([
  ...
  {
    id: 'xyz-real-world-crowd-validation',
    category: 'validation',
    audience: ['investor', 'developer', 'user'],
    x: 'Crowd-band estimates are validated against independent real-world observations.',
    y: 'BLOCKED: no real ground-truth dataset has yet met the reporting gate; accuracy, confidence intervals and false-high/false-low rates remain unclaimed.',
  ...
  {
    id: 'xyz-buyer-task-value',
    category: 'business-validation',
    audience: ['investor'],
    x: 'A target operator completes a real crowd-planning decision measurably better with Eye of Argus than with the current baseline.',
    y: 'BLOCKED: no baseline-vs-Argus task study, repeat-use evidence or willingness-to-pay signal has been collected.',
